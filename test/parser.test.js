...
const readJSONFile = (fileName) => {
    const filePath = path_1.default.resolve(__dirname, `../data/tests/${fileName}`);
...
describe("JSON Parser", () => {
    test("parses valid JSON", () => {
        ...
        const tokens = (0, tokenizer_1.tokenizer)(validJSON);
    ...
    test("throws error on invalid JSON", () => {
        ...
        const tokens = (0, tokenizer_1.tokenizer)(invalidJSON);
        expect(() => (0, parser_1.parser)(tokens)).toThrow();
    });
});
